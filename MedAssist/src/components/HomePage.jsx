...
export default function HomePage() {
  return (
      <div
          className="min-h-screen bg-[rgb(128,178,214)] bg-no-repeat p-8 "
          // style={{ backgroundImage: `url(${signupBackground})` }}
      >
        <div
            className=" bg-[url('assets/signup_no_background.png')] bg-contain bg-no-repeat w-screen h-screen absolute left-5 pointer-events-none z-10"></div>
